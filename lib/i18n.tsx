...
const STRINGS: Record<string, { ar: string; en: string }> = {
  ...
  // أداة العلامة المائية + الضغp (جديد)
  toolWatermark: { ar: 'علامة مائية', en: 'Watermark' },
  toolWatermarkDesc: { ar: 'نص مائل على كل صفحة', en: 'Diagonal text on every page' },
  toolCompress: { ar: 'ضغط الملفات', en: 'Compress' },
  toolCompressDesc: { ar: 'تصغير حجم الـ PDF', en: 'Reduce PDF size' },

  // شاشة العلامة المائية
  wmTitle: { ar: 'علامة مائية', en: 'Watermark' },
  wmTextLabel: { ar: 'نص العلامة', en: 'Watermark text' },
  wmTextPlaceholder: { ar: 'مثال: سرّي، اسم شركتك…', en: 'e.g. Confidential, your company…' },
  wmOpacity: { ar: 'الشفافية', en: 'Opacity' },
  wmOpacity_light: { ar: 'خفيفة', en: 'Light' },
  wmOpacity_medium: { ar: 'متوسطة', en: 'Medium' },
  wmOpacity_strong: { ar: 'قوية', en: 'Strong' },
  wmNote: { ar: 'يُضاف النص مائلاً في وسط كل صفحة بشفافية. يعمل بدون إنترنت.', en: 'Adds the text diagonally centered on every page. Works offline.' },
  wmBtn: { ar: 'إضافة العلامة وحفظ', en: 'Add watermark & Save' },
  wmNoTextT: { ar: 'لا يوجد نص', en: 'No text' },
  wmNoText: { ar: 'أدخل نص العلامة المائية أولاً.', en: 'Please enter the watermark text first.' },
  wmFailed: { ar: 'فشلت إضافة العلامة', en: 'Watermark failed' },

  // شاشة الضغp
  compressTitle: { ar: 'ضغط الملفات', en: 'Compress PDF' },
  compressLevel: { ar: 'مستوى الضغp', en: 'Compression level' },
  compressLow: { ar: 'خفيف', en: 'Low' },
  compressMedium: { ar: 'متوازن', en: 'Balanced' },
  compressHigh: { ar: 'أقصى', en: 'Maximum' },
  compressOnlineNote: { ar: 'يتم الضغp عبر الإنترنت لجودة أفضل. يتطلب اتصالاً.', en: 'Compression runs online for better quality. Requires internet.' },
  compressBtn: { ar: 'ضغط وحفظ', en: 'Compress & Save' },
  compressBusy: { ar: 'جارٍ الضغp…', en: 'Compressing…' },
  compressSaved: { ar: 'وفّرت', en: 'Saved' },
  ...
  catSecurity: { ar: 'الحماية والأمان', en: 'Security' },
  convertTo: { ar: 'تحويل إلى PDF', en: 'Convert to PDF' },
  convertFrom: { ar: 'تحويل من PDF', en: 'Convert from PDF' },
  ...
  myInfoHint: { ar: 'أدخل اسمك ورقم جوالك ليتعرّف عليك مزوّد الخدمة عند تفعيل النسخة الكاملة.', en: 'Enter your name and phone so the provider can identify you when activating the full version.' },
  myNamePlaceholder: { ar: 'الاسم', en: 'Name' },
  myPhonePlaceholder: { ar: 'رقم الجوال', en: 'Phone number' },
  saveInfo: { ar: 'حفظ المعلومات', en: 'Save info' },
  saving: { ar: 'جارٍ الحفظ…', en: 'Saving…' },
  savedMark: { ar: '✓ تم الحفظ', en: '✓ Saved' },
  appearance: { ar: 'المظهر', en: 'Appearance' },
  createTheme: { ar: 'إنشاء ثيم', en: 'Create theme' },
  themeName: { ar: 'اسم الثيم', en: 'Theme name' },
  themeNamePlaceholder: { ar: 'مثال: ثيمي المفضّل', en: 'e.g. My favorite' },
  themeColor: { ar: 'اللون الأساسي', en: 'Primary color' },
  themeMode: { ar: 'الوضع', en: 'Mode' },
  themeDark: { ar: 'داكن', en: 'Dark' },
  themeLight: { ar: 'فاتح', en: 'Light' },
  themeCreate: { ar: 'إنشاء وتطبيق', en: 'Create & apply' },
  themeLongPressHint: { ar: 'اضغط مطوّلاً على ثيم مخصّص لحذفه', en: 'Long-press a custom theme to delete it' },
